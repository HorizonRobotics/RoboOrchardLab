...
@register_adapter("agilex")
class AgilexAdapter(DatasetAdapter):
    """Adapter for flat AgileX entries with ``entry["urdf"]``."""

    packer_module = "config_agilex_dataset"
