...
from robo_orchard_lab.models.sem_modules.structure import (
    SEM_Qwen2_5_VL,
...
__all__ = ["SEM_Qwen3VLTextTemplate", "SEM_Qwen3VL", "SEM_Qwen3VLConfig"]


class SEM_Qwen3VLTextTemplate(nn.Module):  # noqa: N801
...
class SEM_Qwen3VL(SEM_Qwen2_5_VL):  # noqa: N801
    cfg: "SEM_Qwen3VLConfig"

    def __init__(self, cfg: "SEM_Qwen3VLConfig"):
        if Qwen3VLForConditionalGeneration is None or Qwen3VLConfig is None:
            raise ImportError(
                "Building `SEM_Qwen3VL` requires `transformers` >= 4.57.1."
            )
        super(SEM_Qwen2_5_VL, self).__init__(cfg)
...
class SEM_Qwen3VLConfig(SEM_Qwen2_5_VLConfig):  # noqa: N801
    class_type: ClassType_co[SEM_Qwen3VL] = SEM_Qwen3VL
