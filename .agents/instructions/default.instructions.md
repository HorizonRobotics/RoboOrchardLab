...
- Call out risk before proposing breaking, destructive, or environment-dependent changes.
- Do not assume external services, hardware, or network access.
...
- Separate completed changes, remaining risks, and optional follow-up.
