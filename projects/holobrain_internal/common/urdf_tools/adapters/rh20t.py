...
@register_adapter("rh20t")
class Rh20tAdapter(DatasetAdapter):
    """Adapter for RH20T kinematics entries with ``entry["urdf"]``."""

    packer_module = "config_rh20t_dataset"
